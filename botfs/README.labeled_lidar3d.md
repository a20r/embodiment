...
| device          | format                                              |
|-----------------|-----------------------------------------------------|
| `lidar3d`       | point cloud: `x,y,z` triples in meters separated by `;`, in the sensor frame (x forward, y left, z up, origin at the sensor). Points with no return are omitted |
