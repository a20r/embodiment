...
MSG='B: YES keep climbing my sound, I am PARKED SPINNING and will not move. Try every wall opening, even tight. When your d5>1.1 FREEZE next to me and say STOP TEST.'
t_hi=None
def poll():
